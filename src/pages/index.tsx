  ...
  return (
    <Layout>
      <div className={classes.introSection}>
        <p>Hey, I'm <b>Alfin Surya</b> a.k.a <i>Vin</i>. I’m from Bali. I love build things that make useful for another peoples. Lately, I've been interested in tooling, functional programming, and islamic books. Currently open to collaboration, discussion and remote work.</p>
